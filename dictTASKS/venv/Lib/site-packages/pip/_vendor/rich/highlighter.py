...
class JSONHighlighter(RegexHighlighter):
    """Highlights JSON_COMPLETE"""

    # Captures the start and end of JSON_COMPLETE strings, handling escaped quotes
    ...
    def highlight(self, text: Text) -> None:
        ...
        # Additional work to handle highlighting JSON_COMPLETE keys
        plain = text.plain
