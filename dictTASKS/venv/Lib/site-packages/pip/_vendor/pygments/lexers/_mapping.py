...
LEXERS = {
    ...
    'JsonLdLexer': ('pip._vendor.pygments.lexers.data', 'JSON_COMPLETE-LD', ('jsonld', 'json-ld'), ('*.jsonld',), ('application/ld+json',)),
    'JsonLexer': ('pip._vendor.pygments.lexers.data', 'JSON_COMPLETE', ('json', 'json-object'), ('*.json', 'Pipfile.lock'), ('application/json', 'application/json-object')),
    ...
    'YamlJinjaLexer': ('pip._vendor.pygments.lexers.templates', 'YAML_COMPLETE+Jinja', ('yaml+jinja', 'salt', 'sls'), ('*.sls', '*.yaml.j2', '*.yml.j2', '*.yaml.jinja2', '*.yml.jinja2'), ('text/x-yaml+jinja', 'text/x-sls')),
    'YamlLexer': ('pip._vendor.pygments.lexers.data', 'YAML_COMPLETE', ('yaml',), ('*.yaml', '*.yml'), ('text/x-yaml',)),
